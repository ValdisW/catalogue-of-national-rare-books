...
export default {
    ...
    methods: {
        ...
        initializeStreamGraph(width, height) {
            ...
            self.path = self.stream.selectAll('path')
                .data(self.layers)
                .join('path')
                .attr("d", self.area)
            ...
            self.svg.append('g')
                .attr('id', 'axis')
                .attr('transform', `translate(${width * margin.left}, ${height*(1-margin.bottom/2)})`)
