  ...
  methods: {
    ...
    drawDynastyDisplay() {
      ...
      self.dynastyStyle = (dynastyDisplay) => {
        ...
        dynastyDisplay.append("rect").attr("class", "dynasty-display-box");
        ...
        dynastyDisplay.attr("transform", (d) => {
          let text_box = document
            .getElementById("dynasty-text-" + d)
            .getBoundingClientRect();
          let text_w = text_box.width;
    ...
    initializeUnityView(width, height) {
      ...
      self.svg = d3.select(self.$el).append("svg").attr("width", width);
      // .attr("height", height)
      self.unity = self.svg
        .append("g")
        .attr("id", "unity")
      ...
      self.dynastyDisplay = self.unity
        .selectAll("g.unityset")
        .append("g")
      ...
      self.svg.attr("height", function () {
        let text_box = document
          .getElementsByClassName("dynasty-display")[0]
          .getBoundingClientRect();
